...
//获取用户信息
Route::post('userinfo', 'LoginController/userInfo')->name('userInfo')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);

//交换token
Route::post('login/transtoken', 'LoginController/transToken')->name('transToken')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);
...
//获取所有订单
Route::post('get_all_order', 'order.StoreOrderController/getAll')->name('get_all_order')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);

//获取订单详情
Route::post('orderDetail', 'order.StoreOrderController/orderDetail')->name('orderDetail')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);

//配送员 订单操作
Route::post('OrderHandle', 'order.StoreOrderController/deliveryHandle')->name('OrderHandle')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);
...
//切换工作状态
Route::post('transWorkStatus', 'user.UserController/transWorkStatus')  ->name('transWorkStatus')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);



//統計配送員收入
Route::post('workStat', 'user.UserController/workStat')  ->name('workStat')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);;


//申请门店的配送工作
Route::post('applyWorkStore', 'user.UserController/applyWorkStore')  ->name('applyWorkStore')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);;

###################  门店  #####################

//  获取  门店 列表
Route::post('getAllStore', 'store.StoreController/getAll')  ->name('getAllStore')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);

//  获取 配送员工作的门店 列表
Route::post('getWorkStores', 'store.StoreController/getWorkStores')  ->name('getWorkStores')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);


//获取订单详情
Route::post('storeDetail', 'store.StoreController/storeDetail')->name('storeDetail')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);

###############  提现 ################
//发起提现申请
Route::post('withdrawApply', 'finance.WithdrawController/apply')->name('withdrawApply')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);

//获取提现列表
Route::post('withdrawList', 'finance.WithdrawController/list')->name('withdrawList')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);

//获取提现详情
Route::post('withdrawDetail', 'finance.WithdrawController/detail')->name('withdrawDetail')
    ->middleware(\app\http\middleware\AllowOriginMiddleware::class);
