                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {if condition="in_array($gid,[51,62])"}
                                    <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('活动区域商品管理','{:Url('setting.SystemGroupDataProduct/index',array('group_data_id'=>$vo['id']))}')"><i class="fa fa-paste"></i> 管理商品</button>
                                {/if}
