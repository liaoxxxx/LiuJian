    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame('添加活动商品','{:Url('store.storeProduct/activeProduct',array('group_data_id'=>$where.group_data_id))}')">去添加商品</button>
