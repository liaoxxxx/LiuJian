            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <div class="layui-btn-container">
                        {switch name='type'}
                            {case value="1"}
                                <button class="layui-btn layui-btn-sm" data-type="discovery">发现栏推荐</button>
                    ...
                    <script type="text/html" id="act">
                        <button type="button" class="layui-btn layui-btn-xs btn-success" lay-event='label' >
                            标签
                        </button>
...
//                    {field: 'status', title: '状态',templet:"#checkboxstatus"},
    ...
    layList.tool(function (event,data,obj) {
        switch (event) {
            ...
            case 'attr':
                ...
                break;
            case 'label':
                $eb.createModalFrame(data.store_name+'-标签',layList.U({a:'label',q:{id:data.id}}),{h:600,w:800})
                break;
        }
    })
    //排序
    ...
    var action={
        ...
        discovery:function(){
            var ids=layList.getCheckData().getIds('id');
            if(ids.length){
                $eb.createModalFrame('添加发现商品',layList.U({c:'discovery.discovery_product',a:'batch_discovery',p:{ids:ids}}));
            }else{
