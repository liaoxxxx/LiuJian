            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        <h1 style="color: #ffffff;font-weight:400;">管理后台</h1>
<!--                        <span>-->
...
<!--                        </span>-->
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe_common_main" width="100%" height="100%" src="{:Url('Index/main')}" frameborder="0" data-id="{:Url('Index/main')}" seamless></iframe>
        </div>
        <!--底部版权-->
        <div class="footer"  @touchmove.prevent>
            <div class="pull-right">© 2020 <a href="" target="_blank">DIANDIANJIU</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
