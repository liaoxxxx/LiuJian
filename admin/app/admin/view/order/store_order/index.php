        ...
        new Vue({
            ...
            data: {
                ...
                payType: [
                    ...
                    {name: '微信小程序支付', value: 4,count:payTypeCount.weixin_mp_pay},
                    {name: '支付宝支付', value: 5,count:payTypeCount.alipay},
                    {name: '微信H5支付', value: 6,count:payTypeCount.weixinh5},
                ],
                orderType: [
                    {name: '全部', value: ''},
                ...
                orderStatus: [
                    ...
                    {name: '已取消', value: -5,count:orderCount.cancel},
                ],
                dataList: [
                    {name: '全部', value: ''},
                    {name: '今天', value: 'today'},
