                ...
                <div class="panel-body">
                    <div class="row show-grid">
                        ...
                        <div class="col-xs-6" style="color: #8BC34A;">订单状态:
                            {if condition="$orderInfo['paid'] eq 0 && $orderInfo['status'] eq 4"}
                            未支付
                        ...
                        <div class="col-xs-6">支付方式:
                            {if condition="$orderInfo['paid'] eq 1"}
                               ...
                               余额支付
                               {elseif condition="$orderInfo['pay_type'] eq 'weixin_mp_pay'"}
                               微信小程序支付
                               {elseif condition="$orderInfo['pay_type'] eq 'weixinh5'"}
                               微信H5支付
                               {elseif condition="$orderInfo['pay_type'] eq 'alipay'"}
                               支付宝支付
