...
class SystemAdmin extends BaseModel
{
     ...
     * @return \think\Collection
     */
    public static function getBindingStore(array $storeIds){
      return  SystemStore::where( 'id','in',$storeIds)->where('is_del',0)->select();
    }
     ...
     * @return SystemAdmin
     */
    public static function saveBindStore($adminId,$storeIdList)
    {
      return  self::where('id',$adminId)->update(['store_ids'=>json_encode($storeIdList)]);
    }
}