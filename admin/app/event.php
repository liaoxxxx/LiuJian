...
return [
    ...
    'listen'    => [
        ...
        'WechatMessageBefore' => [], // MessageSubscribe 微信消息前置操作  common\services\WechatService
        'WechatEventUnsubscribeBefore' => [], // MessageSubscribe 用户取消关注公众号前置操作  common\services\WechatService
    ...
    'subscribe' => [
        common\subscribes\SystemSubscribe::class,
        common\subscribes\OrderSubscribe::class,
        common\subscribes\ProductSubscribe::class,
        common\subscribes\UserSubscribe::class,
        common\subscribes\MaterialSubscribe::class,
        common\subscribes\MessageSubscribe::class,
        common\subscribes\TaskSubscribe::class,
    ],
];
