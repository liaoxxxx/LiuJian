...
INSERT INTO `eb_system_config` ( `menu_name`, `type`, `input_type`, `config_tab_id`, `parameter`, `upload_type`, `required`, `width`, `high`, `value`, `info`, `desc`, `sort`, `status`) VALUES ('h5_avatar', 'upload', '', 1, '', 1, '', '', '', '"http:\/\/www.common3.net\/uploads\/attach\/2019\/08\/20190802\\b4b7963527d884a82a950027d5cba023.png"', '用户H5默认头像', '用户H5默认头像', 0, 1);
