...
公众号和H5首页访问地址：
1.域名/
提示：正常访问是第一中模式，第一种访问不了请检测[URL重写](http://help.common.net/895486)是否配置好
安装过程中请牢记您的账号密码！
...
## 手动安装
1.创建数据库，导入数据库文件
数据库文件目录/public/install/common.sql
2.修改数据库连接文件
配置文件路径/.env
~~~
APP_DEBUG = true
...
# 配送通讯通知
php think workerman start delivery
```
参数
- status: 状态
    - start: 启动
