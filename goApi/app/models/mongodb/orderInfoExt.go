...
type OrderInfoExt struct {
	...
	WeightCateId     string   `json:"user_weight_cate_id"  ;bson:"weight_cate_id"`
	...
	RecCateId        string   `json:"user_rec_cate_id"  ;bson:"user_rec_cate_id"`
	CreateTime       time.Time
}

func (recOrderInfoExt *OrderInfoExt) CollectionName() string {
